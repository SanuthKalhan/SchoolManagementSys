  ...
  return (
    <div className="fixed top-0 left-0 right-0 flex justify-between items-center p-4 bg-white border rounded-5xl z-10">
      <div className='flex flex-row items-center'>
        <div className="text-xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
      ...
      <div className="flex items-center space-x-4">
        <button className="flex items-center text-gray-600 hover:text-red-500">
          ...
          <span className="ml-2 hidden sm:flex border px-3 py-1 rounded-3xl text-xs border-red-500 text-red-500 hover:text-white hover:bg-red-500">Log Out</span>
        </button>
